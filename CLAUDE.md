...
**2026-05-31 — `Layer 2 docs`: tone down README (emotional copy → matter-of-fact) + scope cuts to BUILD_PLAN**
- Pre-public-flip session. Alan's direction this session was "make this live, no extra stuff" then "update the readme so it's not so emo." Two threads: (1) trim Layer 2 scope down to just the public flip, (2) de-emotionalize the README before it's visible to the public.
